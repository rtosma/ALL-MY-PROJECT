    ...
    public partial class Sakin : Form
    {
        ...
        void toplama()
        {
            try
            {
                ...
                SqlDataAdapter ad = new SqlDataAdapter("Select SUM(tutar)From borclar where kullanici='"+Form1.giris+"'", baglan.baglan());
        ...
        void odenen()
        {
            try
            {
                ...
                SqlDataAdapter ad = new SqlDataAdapter("Select SUM(miktar)From odenen  where odeyen='" + Form1.giris + "' ",  baglan.baglan());
                DataTable dt = new DataTable();
                ad.Fill(dt);
        ...
        private void textBox1_TextChanged_1(object sender, EventArgs e)
        {
            ...
            DataTable dt = new DataTable();
            SqlDataAdapter ad = new SqlDataAdapter("SELECT * FROM borclar WHERE kategori LIKE'%" + textBox1.Text + "%' and kullanici='" + Form1.giris + "'or aciklama LIKE '%" + textBox1.Text + "' and kullanici='" + Form1.giris + "'or tutar LIKE '%" + textBox1.Text + "' and kullanici='" + Form1.giris + "'", baglan.baglan());
            ad.Fill(dt);
            dataGridView4.DataSource = dt;
        ...
        private void button9_Click_1(object sender, EventArgs e)
        {
            ...
            SqlCommand komutum = new SqlCommand("update kullanici set  ad = '" + textBox10.Text + "',soyisim = '" + textBox11.Text + "',email='" + textBox12.Text + "',telefon='" + textBox13.Text + "',daire_no='" + textBox14.Text + "',ev_durumu='" + comboBox5.Text + "'  where tc_no='" + Form1.giris + "'", baglan.baglan());
        ...
        private void button10_Click_1(object sender, EventArgs e)
        {
            if (textBox18.Text == Form1.sifre)
            {
                if (textBox17.Text == textBox16.Text)
                {
                    ...
                    komut = new SqlCommand("update kullanici set sifre ='" + TextSifrele(textBox17.Text) + "'where tc_no='" + Form1.giris + "'", baglan.baglan());
        ...
        /*    komut = new SqlCommand("select * from kullanici where tc_no='" + Form1.giris + "'", baglan.baglan());
            komut.ExecuteNonQuery();
