...
namespace personel_takip_programı
{
    public partial class Form3 : Form
    {
        ...
        private void personelleri_goster()
            ...
            {
                MessageBox.Show(erormsj.Message, "SKY Personel Takip Programı", MessageBoxButtons.OK, MessageBoxIcon.Error);
                baglantim.Close();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (maskedTextBox1.Text.Length==11)
            {
                ...
                while (kayitokuma.Read())
                {
                    ...
                    {
                        pictureBox1.Image = Image.FromFile(Application.StartupPath + "\\personelresimler\\resmiyok.png");
